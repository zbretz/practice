...
const romanToInteger = (roman) => {
  ...
  for(let stringIndex = 0; stringIndex < roman.length; stringIndex++){
    if (compound[roman[stringIndex] + roman[stringIndex + 1]]){
      num += compound[roman[stringIndex] + roman[stringIndex + 1]]
      stringIndex++
    } else{
      num += dictionary[roman[stringIndex]]
    }
  }
  return num
}
